...
parser.add_argument('--node_embedding', type=str, default='genre_metapath2vec.pt', help='Node embedding file name.')
parser.add_argument('--label', type=str, default='genre', help='Label projection. Options: (style|genre).')
