...
do
    ...
    do
        ...
        python3 run.py --exp resnet-baseline --mode single_task --label $label --epochs 100 --lr $lr
        ((n=n+1))
    done
done
...
do
    ...
    do
        ...
        python3 run.py --exp resnet-baseline --mode single_task --label $label --epochs 100 --freeze --lr $lr
        ((n=n+1))
    done
done
